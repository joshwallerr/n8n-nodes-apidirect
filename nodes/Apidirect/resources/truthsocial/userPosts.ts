...
export const truthsocialUserPostsFields: INodeProperties[] = [
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: "number",
				default: 1,
				description: "Number of pages to fetch, 1-10 (default: 1). Each page returns up to 20 posts. Each page fetched is billed as one request.",
				routing: {
					send: {
						type: "query",
						property: "pages",
